...
const SelectPayment = (props) => {
  return (
    <TouchableOpacity style={{flexDirection:'row',justifyContent:'space-around',marginTop:"5%",width:"95%",alignSelf:'center'}}>
          ...
          <Image style={{width:35,height:35}} source={{uri:"https://img2.arabpng.com/20180419/wsw/kisspng-payment-gateway-credit-card-computer-icons-point-o-automotive-industry-business-card-5ad93c4a689256.4385955015241861864283.jpg"}} />
          </View>
